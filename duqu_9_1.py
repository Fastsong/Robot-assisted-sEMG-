...
#读入肌电数据，并且调整通道
data1 = pd.read_csv('D:/sEMG_0909/zsw/AG1.emt', skiprows=10, delimiter='\t', low_memory=False)
arr1 = data1.values
AGemg1 = np.copy(arr1)
AGemgg1 = AGemg1[:, 2:10]
AGemgg1[:, [2, 3, 4, 5, 6, 7, 0, 1]] = AGemgg1[:, [0, 1, 2, 3, 4, 5, 6, 7]]

data2 = pd.read_csv('D:/sEMG_0909/zsw/AG2.emt', skiprows=10, delimiter='\t', low_memory=False)
arr2 = data2.values
AGemg2 = np.copy(arr2)
AGemgg2 = AGemg2[:, 2:10]
AGemgg2[:, [2, 3, 4, 5, 6, 7, 0, 1]] = AGemgg2[:, [0, 1, 2, 3, 4, 5, 6, 7]]

data3 = pd.read_csv('D:/sEMG_0909/zsw/DX1.emt', skiprows=10, delimiter='\t', low_memory=False)
arr3 = data3.values
DXemg1 = np.copy(arr3)
DXemgg1 = DXemg1[:, 2:10]
DXemgg1[:, [2, 3, 4, 5, 6, 7, 0, 1]] = DXemgg1[:, [0, 1, 2, 3, 4, 5, 6, 7]]

data4 = pd.read_csv('D:/sEMG_0909/zsw/DX2.emt', skiprows=10, delimiter='\t', low_memory=False)
arr4 = data4.values
DXemg2 = np.copy(arr4)
DXemgg2 = DXemg2[:, 2:10]
...
# df = pd.DataFrame(AGzhengti)
# df.to_csv('D:/sEMG_1213/output2.txt', index=False, header=False)
#
#
# # 读取
# new_list = pd.read_csv('D:/sEMG_1213/output2.txt', header=None).values.tolist()
# import ast
...
AGduandian = [
            ...
            'x:-0.05743 y:0.649063', 'x:-0.124294 y:0.582199', 'x:-0.191158 y:0.515335'
            ]
...
scio.savemat('D:/sEMG_0909/Split/S1_data1.mat',
...
scio.savemat('D:/sEMG_0909/Split/S1_data2.mat',
